...
def initialize_site(user):
    ...
    Site.objects.create(site_name='创新实践', site_url='https://uitp.sjtu.edu.cn/innovation/index.html/', site_src='../static/img/大创.png', user=user)
    Site.objects.create(site_name='教学楼', site_url='https://ids.sjtu.edu.cn/', site_src='../static/img/教学楼.png', user=user)
    Site.objects.create(site_name='图书馆', site_url='https://www.lib.sjtu.edu.cn/f/main/index.shtml/', site_src='../static/img/图书馆.png', user=user)
